            ...
            <div class="col-xl-8 mx-auto">
                <div class="card">
                    <div class="card-body p-4">
                        <h5 class="mb-4">Form Edit Satuan Barang</h5>
                        <form class="needs-validation" id="editSatuanForm" novalidate>
                            <div class="row mb-3">
                                <input type="hidden" name="id" value="{{ $satuan->id }}">
                                <label for="inputSatuanName" class="col-sm-3 col-form-label">Nama Satuan</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="inputSatuanName" name="name" placeholder="Masukkan Nama Satuan" value="{{ $satuan->name }}" required>
...
<script>
    $(document).ready(function() {
        ...
        $('#editSatuanForm').submit(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: '/admin/satuan/update', // Ganti dengan URL tujuan pengiriman data
                data: formData,
